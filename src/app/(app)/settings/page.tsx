              ...
              <table className="w-full text-left text-xs sm:text-sm whitespace-nowrap min-w-[600px]">
                 ...
                 <tbody className="divide-y divide-gray-50">
                    {users.length === 0 ? (
                       ...
                       <AnimatePresence>
                          {users.map((user) => (
                          <motion.tr key={user.id} variants={itemVariants} layout initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="hover:bg-slate-50 transition-colors group">
