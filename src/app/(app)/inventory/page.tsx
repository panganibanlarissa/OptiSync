      ...
      <div className="flex flex-col lg:flex-row gap-2 sm:gap-3 lg:gap-4 w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full pl-8 sm:pl-9 pr-3 py-1.5 sm:py-2 rounded-md sm:rounded-lg border border-gray-300 text-xs sm:text-sm focus:outline-none focus:ring-1 focus:ring-[#0B3C8A] transition-all text-gray-700 placeholder-gray-400" 
                />
              </div>
        ...
        <aside className="w-full lg:w-70 xl:w-75 flex flex-col gap-2 sm:gap-3 lg:gap-4 shrink-0 order-last lg:order-0">
          <motion.div 
            ...
            className="bg-white p-3 sm:p-4 rounded-xl shadow-sm border border-slate-200"
          >
...
function ProductCard({ data, viewMode, onEdit, onAdjust }: { 
  data: InventoryData, 
  viewMode: 'grid' | 'list', 
  onEdit: () => void, 
  onAdjust: () => void 
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4">
              ...
              <div>
                ...
                <input 
                  ...
                  placeholder="0" 
                  disabled={mode === 'edit'} 
                  className={`w-full px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-md sm:rounded-lg border border-gray-300 text-[11px] sm:text-sm focus:ring-1 ${THEME_RING} focus:outline-none ${mode === 'edit' ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'text-gray-700 placeholder-gray-400'}`} 
                />
              </div>
            </div>
