...
interface FirebaseContextType {
  ...
  // Products
  products: Product[];
  addProduct: (product: Omit<Product, 'id' | 'createdAt' | 'updatedAt' | 'totalSold'>) => Promise<void>;
...
export function FirebaseProvider({ children }: { children: ReactNode }) {
  ...
  const addProduct = async (product: Omit<Product, 'id' | 'createdAt' | 'updatedAt' | 'totalSold'>) => {
