...
export default function ReportsPage() {
  ...
  const exportLedgerReport = () => {
    ...
    autoTable(doc, {
      ...
      didDrawPage: (data) => {
        ...
        doc.text(`Period: ${periodText} | Generated: ${new Date().toLocaleDateString()} | Generated by: ${appUser?.name || 'System'}`, pageWidth / 2, 31, { align: 'center' });
  ...
  const exportInventoryOptimizationReport = () => {
    ...
    const addHeader = (pageNumber: number) => {
      ...
      doc.setFontSize(9);
      doc.text(`Period: ${periodText} | Generated: ${today.toLocaleDateString()} | Generated by: ${appUser?.name || 'System'}`, pageWidth / 2, 31, { align: 'center' });
      doc.setDrawColor(200, 200, 200);
      doc.line(14, 35, pageWidth - 14, 35);
    };
